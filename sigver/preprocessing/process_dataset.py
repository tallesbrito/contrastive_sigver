...
def process_dataset(dataset: IterableDataset,
    ...
    """
    if subset is None:
        print('Processing all users from the dataset.')
    else:
        print('Processing only users from the interval:', subset)
...
if __name__ == '__main__':
    ...
    process_dataset(dataset, args.save_path, args.image_size, args.users)
